    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                if let licenseURL = URL(string: "https://l1fe.network/terms") {
                    Link("License agreement", destination: licenseURL)
                        .font(.system(size: 18, weight: .medium))
                        .padding(.bottom, UIScreen.main.bounds.height * 0.04)
                }
                
                if let privacyURL = URL(string: "https://l1fe.network/privacy") {
                ...
                Text("© 2025-2026 L1fe AI, Inc. All rights reserved")
