...
struct ServerView: View {
    ...
    private let defaultManagementServerUrl = "https://api.vpn.l1fe.network"
    ...
    @ViewBuilder
    func buildUseOneNetButton() -> some View {
        Button {
            hideKeyboard()
            ...
            Label("Use L1fe Network server", image: "icon-onenet-button")
                .font(.headline)
                .padding()
