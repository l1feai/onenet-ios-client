...
struct AdvancedView: View {
    ...
    func shareButtonTapped() {
        Task.detached(priority: .utility) {
            ...
            let tempDir = fileManager.temporaryDirectory.appendingPathComponent("onenet-logs-\(UUID().uuidString)")
            ...
            if let goLogURL = AppLogger.getGoLogFileURL() {
                let goLogPath = tempDir.appendingPathComponent("onenet-engine.log")
            ...
            if let swiftLogURL = AppLogger.getLogFileURL() {
                let swiftLogPath = tempDir.appendingPathComponent("onenet-app.log")
