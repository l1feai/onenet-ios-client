...
struct ChangeServerAlert: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("Changing server will erase the local config and disconnect this device from the current OneNet account.")
                .foregroundColor(Color("TextAlert"))
