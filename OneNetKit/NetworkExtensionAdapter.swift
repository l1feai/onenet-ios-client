...
public class NetworkExtensionAdapter: ObservableObject {
    ...
    var extensionID = "network.l1fe.onenetwork.NetworkExtension"
    var extensionName = "OneNetwork Extension"
    ...
    public func isLoginRequired() -> Bool {
        guard let client = OneNetSDKNewClient(Preferences.configFile(), Preferences.stateFile(), Device.getName(), Device.getOsVersion(), Device.getOsName(), nil, nil) else {
