...
class ConnectionListener: NSObject, OneNetSDKConnectionListenerProtocol {
    
    var completionHandler: (Error?) -> Void
    
    var adapter: OneNetAdapter
    
    init(adapter: OneNetAdapter, completionHandler: @escaping (Error?) -> Void) {
